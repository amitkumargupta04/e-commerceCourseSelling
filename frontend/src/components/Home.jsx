    ...
    <div className="bg-gradient-to-r from-black to-blue-950 ">
      <div className="h-[1250px] md:h-[1050px] text-white container mx-auto">
        ...
        <section className="text-center  py-10">
          <h1 className="text-4xl mt-15 font-semibold text-orange-500">
            CourseHaven
          </h1>
          ...
          <div className="space-x-4 mt-8">
            <Link
              to={"/courses"}
              className="bg-green-500 text-white p-3 md:py-4 md:px-8 rounded font-semibold hover:bg-white duration-300 hover:text-black"
            >
              Explore courses
            </Link>
          </div>
                ...
                <div className="relative transition-transform duration-300 transform hover:scale-105">
                  <div className="bg-gray-900 rounded-md overflow-hidden shadow-md">
                    ...
                    <div className="p-3 text-center space-y-2">
                      ...
                      <Link
                        to={`/buy/${course._id}`}
                        className="inline-block bg-orange-500 text-white text-sm py-1.5 px-4 rounded-full hover:bg-blue-500 transition duration-300"
                      >
                        Enroll Now
                      </Link>
                    </div>
        ...
        <footer className="my-12">
          <div className="grid grid-cols-1 md:grid-cols-3">
            <div className="flex flex-col items-center md:items-start">
              <div className="flex items-center space-x-2">
                <img src="https://images-platform.99static.com//KlBLMX8dQrcq6hZGnxf5HSnG29I=/8x543:525x1060/fit-in/500x500/99designs-contests-attachments/123/123360/attachment_123360235" alt="" className="w-10 h-10 rounded-full" />
